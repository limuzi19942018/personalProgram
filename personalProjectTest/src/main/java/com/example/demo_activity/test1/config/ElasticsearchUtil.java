 ...
 * @Author: yongl
 * @DATE: 2020/6/9 14:04
 * @Deprection 该ElasticSearch采用的是 TransportClient 的方式，在ElasticSearch官网
 * 上介绍，ElasticSearch官方建议在7.0版本不使用TransportClient的方式，建议使用RestHighLevelClient
 * 的方式，在ElasticSearch8.0版本，会删除TransportClient
 */
